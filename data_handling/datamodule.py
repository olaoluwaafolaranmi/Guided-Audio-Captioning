...
def collate_fn(batch):
    ...
    for waveform, text, keyword, audio_name, audio_idx in batch:
    ...
    keywords_list = torch.stack(keywords_list, dim=0)
    return waveforms, text_list, audio_name_list, audio_idx, keywords_list
