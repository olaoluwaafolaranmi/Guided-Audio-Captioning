...
dev_csv_file = 'data/Clotho/csv_files/train.csv'
val_csv_file = 'data/Clotho/csv_files/val.csv'
eval_csv_file = 'data/Clotho/csv_files/test.csv'
...
# train the model
model = Word2Vec(clotho_captions, vector_size=768, min_count=1, window=3, epochs=1000)
print('Training finished.\n')
model.save('pretrained_models/word2vec/w2vclotho.model')
